...
export function getAnthropicApiKeyWithSource(
  ...
  // Third-party Anthropic-compatible API (e.g. Kimi Code, LiteLLM): when
  // ANTHROPIC_BASE_URL is not 1P, accept ANTHROPIC_API_KEY from env without
  // OAuth or the interactive ApproveApiKey approval list (same idea as -p mode).
